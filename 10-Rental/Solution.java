...
public class Solution {
    ...
    static class RentalManager {
       ...
       public List<Integer> getActiveReservationIds(){
       ...
       public Map<String, Integer> getTotalMinutesByStatus(){
    	   ...
    	   for(Reservation res:reservations) {
    		   result.put(String.valueOf( res.status), result.getOrDefault(String.valueOf(res.status),0)+res.getDuration());
    	   }
    	  ...
    	  for(Reservation res:reservations) {
    		  if(res.status==ReservationStatus.ACTIVE) {
    			  active+=res.getDuration();
    		  }
    		  else {
    			  cancel+=res.getDuration();
    		  }
    	  }
    	   result.put("ACTIVE",active);
    	   result.put("CANCELLED",cancel);
    	  return result;    	   
